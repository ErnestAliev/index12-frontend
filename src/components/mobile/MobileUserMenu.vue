...
Настройки</span>
          ...
          <button class="menu-item" @click="handleToggleTheme">
            <div class="menu-item-icon">
              <svg v-if="currentTheme === 'dark'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
const currentTheme = computed(() => document.documentElement.getAttribute('data-theme') || 'dark');
