...
/**
 * * --- МЕТКА ВЕРСИИ: v51.0 - CLEANUP ---
 * * ВЕРСИЯ: 51.0 - Удалена кнопка прямого закрытия розницы (теперь через редактор)
 */
  ...
  <div class="dashboard-card">
    <div class="card-title-container card-drag-handle">
      ...
      <div class="card-actions">
        <!-- Кнопка списания убрана, так как функционал перенесен внутрь редактора (карандаш) -->
        <button 
        ...
        <button @click.stop="$emit('edit')" class="action-square-btn" title="Редактировать и Закрыть">
