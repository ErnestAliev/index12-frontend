        ...
        <div v-if="isWidgetFullscreen" class="fullscreen-widget-overlay">
             <div class="fs-header">
                ...
                <div class="fs-controls">
                    <button v-if="activeWidgetKey === 'accounts' && (!mainStore.workspaceRole || mainStore.isWorkspaceOwner)" class="action-square-btn" :class="{ active: mainStore.includeExcludedInTotal }" @click="mainStore.toggleExcludedInclusion()" title="Учитывать скрытые счета">
